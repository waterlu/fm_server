 ...
 */
@RestController
@RequestMapping(value = "/fmChannel")
public class FmChannelController extends BaseController<FmChannel, FmChannelDTO, FmChannelQueryDTO> {

    @Autowired
    private FmChannelService fmChannelService;
     ...
     */
    @Override
    public BaseService<FmChannel, FmChannelQueryDTO> getService() {
        return fmChannelService;
    }
     ...
     */
    @Override
    public void setEntityId(FmChannel entity, Object id) {
        entity.setId((Long)id);
    }

    @Override
    @ApiOperation(value = "创建", response = FmChannelVO.class, notes = "创建接口描述")
    public ResponseResult create(@RequestBody @Validated({InsertGroup.class}) FmChannelDTO param) throws BizException {
        return super.create(param);
    }

    @Override
    @ApiOperation(value = "获取详情接口", response = FmChannelVO.class, notes = "获取详情接口描述")
    ...
    public ResponseResult update(@PathVariable Long id, @RequestBody @Validated({UpdateGroup.class}) FmChannelDTO param) throws BizException {
     ...
     */
    @Override
    protected FmChannel paramToEntity(FmChannelDTO param) {
     ...
     */
    @Override
    protected ResponseData entityToVo(FmChannel entity) {
