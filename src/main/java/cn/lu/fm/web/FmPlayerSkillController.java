 ...
 */
@RestController
@RequestMapping(value = "/fmPlayerSkill")
public class FmPlayerSkillController extends BaseController<FmPlayerSkill, FmPlayerSkillDTO, FmPlayerSkillQueryDTO> {

    @Autowired
    private FmPlayerSkillService fmPlayerSkillService;
     ...
     */
    @Override
    public BaseService<FmPlayerSkill, FmPlayerSkillQueryDTO> getService() {
        return fmPlayerSkillService;
    }
     ...
     */
    @Override
    public void setEntityId(FmPlayerSkill entity, Object id) {
        entity.setId((Long)id);
    }

    @Override
    @ApiOperation(value = "创建", response = FmPlayerSkillVO.class, notes = "创建接口描述")
    public ResponseResult create(@RequestBody @Validated({InsertGroup.class}) FmPlayerSkillDTO param) throws BizException {
        return super.create(param);
    }

    @Override
    @ApiOperation(value = "获取详情接口", response = FmPlayerSkillVO.class, notes = "获取详情接口描述")
    ...
    public ResponseResult update(@PathVariable Long id, @RequestBody @Validated({UpdateGroup.class}) FmPlayerSkillDTO param) throws BizException {
     ...
     */
    @Override
    protected FmPlayerSkill paramToEntity(FmPlayerSkillDTO param) {
     ...
     */
    @Override
    protected ResponseData entityToVo(FmPlayerSkill entity) {
